...
## [Comedy](/comedy/) is covered on another page of this site

---

## The Maker Movement

I am very involved in the maker movement. I co-founded a successful community makerspace, [Decatur Makers](https://decaturmakers.org/), located in downtown Decatur. I was also on the board of the Southeast Makers Alliance and have been involved as a co-producer of Maker Faire Atlanta since 2014.

### STEM Extension Service

In 2016, I was invited to visit the White House Office of Science and Technology Policy (OSTP) for a meeting of makerspace organizers. While there, I had a discussion with Andrew Coy, currently at the Digital Harbor Foundation, about the 4-H program and the maker movement. When I got back to Georgia Tech, I wrote up some ideas about a [STEM Extension Service](/assets/documents/STEM-extension-service.pdf).
...
---
<!--
## Current Hobbies & Workshop

*(Draft section: A great place to drop in photos of your Prusa 3D printing setup, details on your Arduino electronics builds, or photos from a recent board game night!)*


{% include gallery id="hobby_gallery" caption="Recent workshop and tabletop projects." %}
-->